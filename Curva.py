...
class Curva:
    ...
    def interpolacion(s,p:int=0,r:float=0.0) -> list:
        ...
        if p == 0:
           ...
           for j in range(1,s.dim):
              xi.append(a*s.x[ipl+j*s.n]+(1.0-a)*s.x[i+j*s.n])
...
#==============================================================================
# Funcion zspline crea el Z-spline de un conjunto de puntos de dim dimensiones
# 
# n segmentos y continuidad (aproximacion) cont 
# x,y = zspline(conjunto de puntos , dimensiones, numero de segmentos, continuidad)
